...
Write-Host "Checking for updates (Boost)..." -ForegroundColor Cyan

$apiUrl = "https://api.github.com/repos/GRILLYje/Fishing_Boost_Public/releases/latest"
...
$folderPath = Join-Path -Path $baseTemp -ChildPath "Boost"
...
Write-Host "Launching Boost..." -ForegroundColor Green
